...
export default function Community({ user }) {
    ...
    return (
        // 1. CHỈNH SỬA CONTAINER NGOÀI CÙNG (Thêm padding để giống Setting)
        <div className="relative isolate px-6 pt-24 lg:px-48 bg-gray-900 overflow-hidden h-screen">

            {/* Background Blob giống Setting */}
            <div
                aria-hidden="true"
            ...
            {/* 2. KHUNG CARD CHÍNH (Thêm styling bo tròn, border, màu nền trong suốt giống Setting) */}
            <div className="relative w-full max-w-7xl mx-auto bg-gray-900/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-black/40 flex flex-col overflow-hidden h-[80vh]">
                ...
                {/* List Section (Scroll nằm gọn trong Card) */}
