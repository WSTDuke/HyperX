...
const DeleteConfirmModal = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center w-screen h-screen">
      ...
      {}
      <div className="bg-[#0B0D14] border border-white/10 rounded-2xl shadow-2xl max-w-sm w-full p-6 relative z-10 animate-in fade-in zoom-in-90 slide-in-from-bottom-4 duration-300 ease-out mx-4">
