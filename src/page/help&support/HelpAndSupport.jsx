    ...
    orders: [
      {
        ...
        answer:
          "You can track your order by going to the 'Orders' tab in your profile. Click on the specific order to see real-time shipping updates.",
      },
      {
        question: "Can I change my shipping address?",
        answer:
          "Shipping addresses can only be changed within 1 hour of placing the order. Please contact support immediately via Live Chat.",
      },
      {
        question: "What is the estimated delivery time?",
        answer:
          "Standard shipping takes 3-5 business days. Express shipping takes 1-2 business days depending on your location.",
      },
    ],
    billing: [
      {
        ...
        answer:
          "Refunds are processed within 5-7 business days after we receive your returned item. Navigate to 'My Orders' > 'Return Item' to start the process.",
      },
      {
        question: "Where can I find my invoice?",
        answer:
          "Invoices are sent to your email immediately after purchase. You can also download them from your Order History.",
      },
    ],
    account: [
      {
        ...
        answer:
          "Go to Settings > Security and click on 'Change Password'. If you cannot login, use the 'Forgot Password' link on the login page.",
      },
      {
        question: "Can I delete my account?",
        answer:
          "Yes, you can request account deletion in the 'General' settings tab. Please note this action is irreversible.",
      },
    ],
    tech: [
      {
        ...
        answer:
          "Please ensure you have the latest version installed. Try clearing the cache or reinstalling the application.",
      },
      {
        question: "I'm not receiving email notifications.",
        answer:
          "Check your spam folder. Also, ensure that email notifications are enabled in your Account Settings.",
      },
    ],
  };
          ...
          <aside className="w-full lg:w-80 border-b lg:border-b-0 lg:border-r border-white/10 bg-white/[0.02] lg:bg-transparent p-6 flex flex-col justify-between">
            <div>
              <h2 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-6 px-2 flex items-center gap-2">
                <HelpCircle className="text-cyan-500" size={16} /> Support
                Center
              </h2>
              <nav className="space-y-2">
                {categories.map((cat) => (
                  ...
                  >
                    <span
                      className={`transition-transform duration-300 ${activeTab === cat.id && !searchQuery ? "scale-110" : "group-hover:scale-110"}`}
                    >
                      {cat.icon}
                    </span>
                    {cat.label}
            ...
            <div className="mt-8 p-5 rounded-2xl bg-gradient-to-br from-cyan-900/10 to-blue-900/10 border border-cyan-500/10 relative overflow-hidden">
              ...
              <h3 className="text-white font-bold mb-1 text-sm relative z-10">
                ...
                {filteredFaqs.length > 0 ? (
                  filteredFaqs.map((faq, index) => (
                    ...
                    >
                      ...
                      >
                        <span
                          className={`font-medium transition-colors text-base pr-4 ${openFaqIndex === index ? "text-cyan-400" : "text-gray-300 group-hover:text-white"}`}
                        >
                          {faq.question}
                        </span>
                        <div
                          className={`p-1 rounded-full transition-all duration-300 ${openFaqIndex === index ? "bg-cyan-500/10 rotate-180" : "bg-white/5 group-hover:bg-white/10"}`}
                        >
                          <ChevronDown
                            className={`transition-colors ${openFaqIndex === index ? "text-cyan-400" : "text-gray-500 group-hover:text-white"}`}
                            size={18}
                          />
                        </div>
                      </button>
                  ...
                  <div className="text-center py-16 bg-white/[0.02] rounded-3xl border border-dashed border-white/10">
                    ...
                    <p className="text-gray-500 text-sm">
                      Try using different keywords or browse the categories.
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-5 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] hover:border-emerald-500/30 transition-all cursor-pointer group">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h5 className="text-white font-bold text-sm group-hover:text-emerald-400 transition-colors">
                          Live Chat
                        </h5>
                  ...
                  <div className="p-5 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] hover:border-blue-500/30 transition-all cursor-pointer group">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h5 className="text-white font-bold text-sm group-hover:text-blue-400 transition-colors">
                          Email Support
                        </h5>
                        <p className="text-gray-500 text-xs mt-1">
                          Response within 24h
