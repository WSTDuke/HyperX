    ...
    <div className="relative isolate overflow-hidden h-screen flex items-center justify-center bg-[#020205] border-t border-white/5 backdrop-blur-3xl">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
        ...
        <p className="mx-auto mt-8 max-w-2xl text-xl leading-relaxed text-gray-500 font-medium">
          Stop wrestling with legacy distribution. Focus on your code. We handle
          the planetary-scale deployment.
        </p>
        ...
        <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-8">
          ...
          <Link
            to="/docs"
            className="group text-sm font-black leading-6 text-gray-500 flex items-center gap-2 hover:text-white transition-all uppercase tracking-[0.3em]"
          >
            Establish Contact{" "}
            <span
              aria-hidden="true"
              className="group-hover:translate-x-3 transition-transform duration-500 text-cyan-500"
            >
              →
            </span>
          </Link>
        ...
        <div className="mt-24 flex items-center justify-center gap-4 opacity-30 group">
          ...
          <span className="text-[10px] font-mono font-bold text-cyan-500 uppercase tracking-[0.5em]">
            Global Relay Active
          </span>
